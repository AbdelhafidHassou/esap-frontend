    ...
    modules: [
      {
        ...
        description:
          "Apprenez à identifier et signaler les tentatives de phishing par email, SMS et appels téléphoniques pour protéger vos comptes et données sensibles.",
      ...
      },
      {
        ...
        description:
          "Maîtrisez les bonnes pratiques de création et gestion des mots de passe, et comprenez l'importance cruciale de l'authentification multifacteur pour sécuriser vos accès.",
        imageUrl:
        ...
        chapters: [
          {
            ...
            body: {
              blocks: [
                { type: "heading", text: "Pourquoi un mot de passe fort ?" },
                {
                  type: "paragraph",
                  text: "Un mot de passe faible peut être cassé en quelques secondes par une attaque par force brute. La longueur et la variété des caractères sont vos meilleures défenses.",
                },
                { type: "heading", text: "Les règles essentielles" },
                {
                  type: "list",
                  items: [
                ...
                {
                  type: "paragraph",
                  text: "Astuce : utilisez une phrase de passe comme « Mon chat mange 3 croquettes ! » — longue, mémorisable et difficile à deviner.",
                },
              ],
            },
          },
          {
            ...
            contentType: "video",
            durationSeconds: 330,
            body: { provider: "youtube", videoId: "pgKaWzTh9i4" },
          },
          {
            id: "ch_it_2_3",
            ...
            body: {
              imageUrl:
                "https://www.lockself.com/hs-fs/hubfs/Sch%C3%A9ma%20d%E2%80%99une%20authentification%20multifacteurs-1.png?width=1280&height=720&name=Sch%C3%A9ma%20d%E2%80%99une%20authentification%20multifacteurs-1.png",
              alt: "Schéma de l'authentification multifacteur",
            },
          },
          {
            id: "ch_it_2_4",
            ...
            durationSeconds: 180,
            body: {
              url: "https://www.staysafeonline.org/fr/articles/authentification-multi-facteurs",
              label: "Consulter le guide de l'ANSSI",
            },
          },
          {
            id: "ch_it_2_5",
            ...
            body: {
              blocks: [
                {
                  type: "heading",
                  text: "Ne jamais partager ses identifiants",
                },
                {
                  type: "paragraph",
                  text: "Le partage d'identifiants est une des principales causes de compromission de comptes. Même un collègue de confiance ne doit jamais recevoir votre mot de passe.",
                },
                {
                  type: "list",
                  items: [
                    "Refusez toute demande de mot de passe, même interne",
                    "Méfiez-vous des e-mails « urgents » demandant vos accès",
                    "Signalez toute demande suspecte à la sécurité",
                  ],
                },
              ],
            },
      ...
      },
      {
        ...
        description:
          "Découvrez comment les ransomwares infectent les systèmes, comment les prévenir efficacement et quelles actions entreprendre en cas d'attaque pour limiter les dégâts.",
      ...
      },
      {
        ...
        description:
          "Comprenez les risques liés aux réseaux Wi-Fi publics et privés, et apprenez à utiliser un VPN pour protéger vos communications et données en transit.",
        imageUrl:
          "https://images.unsplash.com/photo-1565715883021-fb644e2f5e8b",
        order: 4,
        readingTimerSeconds: 180,
        chapters: [
          {
      ...
      },
      {
        ...
        description:
          "Protégez vos smartphones et tablettes professionnels contre les menaces spécifiques aux environnements mobiles, du vol physique aux applications malveillantes.",
        imageUrl:
      ...
      },
      {
        ...
        description:
          "Identifiez les techniques de manipulation psychologique utilisées par les cybercriminels pour obtenir des informations confidentielles et apprenez à vous en protéger.",
    ...
    modules: [
      {
        ...
        description:
          "Identifiez les tentatives de fraude au président et de Business Email Compromise ciblant les services financiers pour détourner des virements et paiements.",
      ...
      },
      {
        ...
        description:
          "Protégez votre entreprise contre les fraudes aux fournisseurs, incluant l'usurpation de RIB et les fausses demandes de modification de coordonnées bancaires.",
      ...
      },
      {
        ...
        description:
          "Adoptez les meilleures pratiques pour sécuriser l'accès aux portails bancaires professionnels, valider les ordres de virement et protéger les jetons d'authentification.",
        imageUrl: "https://images.unsplash.com/photo-1563013544-824ae1b704d3",
        order: 3,
        readingTimerSeconds: 180,
        chapters: [
      ...
      },
      {
        ...
        description:
          "Comprenez les exigences du RGPD applicables aux données financières, y compris le consentement, la minimisation des données et les droits des personnes concernées.",
        imageUrl:
      ...
      },
      {
        ...
        description:
          "Appliquez le principe du moindre privilège aux systèmes financiers, gérez les habilitations par profil et assurez une revue périodique des droits d'accès.",
        imageUrl:
      ...
      },
      {
        ...
        description:
          "Mettez en place des mesures techniques et organisationnelles pour protéger les données financières sensibles contre le vol, la fuite et l'espionnage industriel.",
        imageUrl:
      ...
      },
      {
        ...
        description:
          "Évaluez les risques liés au stockage et au traitement des données financières dans le cloud et appliquez les configurations de sécurité adaptées à ces environnements.",
    ...
    modules: [
      {
        ...
        description:
          "Protégez les informations confidentielles de vos clients stockées dans le CRM contre les accès non autorisés, les fuites et les utilisations abusives.",
      ...
      },
      {
        ...
        description:
          "Reconnaissez les tentatives de phishing spécifiques aux fonctions commerciales, comme les fausses demandes de devis, les usurpations de prospects et les liens malveillants.",
      ...
      },
      {
        ...
        description:
          "Protégez les informations sensibles lors des salons et événements professionnels, incluant la collecte de leads, les démonstrations et la sécurité physique des stands.",
        imageUrl:
      ...
      },
      {
        ...
        description:
          "Préservez la confidentialité des stratégies commerciales, listes de prix, présentations et propositions face aux risques de fuite et d'espionnage concurrentiel.",
        imageUrl:
      ...
      },
      {
        ...
        description:
          "Maîtrisez les risques liés à l'utilisation des réseaux sociaux à des fins professionnelles, évitez les fuites d'informations et protégez votre e-réputation.",
        imageUrl:
...
export const ssiDocuments = [
  ...
  },
  {
    ...
    docType: "link",
    url: "https://example.com/email-policy",
    order: 3,
  },
];
