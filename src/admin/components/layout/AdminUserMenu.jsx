...
export default function AdminUserMenu({ firstName, lastName, email }) {
            ...
            <AlertDialog open={confirmOpen} onOpenChange={setConfirmOpen}>
                <AlertDialogContent className="rounded-sm">
                    ...
                    <AlertDialogFooter>
                        ...
                        <AlertDialogAction className="rounded-sm transition-colors duration-300 ease-in-out bg-primary hover:bg-primary/90" onClick={() => { logout(); navigate("/admin/login", { replace: true }); }}>
                            Se déconnecter
                        </AlertDialogAction>
                    </AlertDialogFooter>
                </AlertDialogContent>
